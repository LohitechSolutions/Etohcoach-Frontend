    ...
    return (
      ...
      <SafeAreaView style={styles.safeAreaContainer}>
        ...
        <View style={styles.mainContainer}>
          ...
          >
            {t("TheReasonWhyWeRequireLogin")} {/*UI Engine::From Sketch*/}
          </Text>
          ...
          >
            ...
            >
              {t("LogInWithFacebook")} {/*UI Engine::From Sketch*/}
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
          ...
          >
            ...
            >
              {t("LogInWithGoogle")} {/*UI Engine::From Sketch*/}
            </Text>
          </TouchableOpacity>
          <Text
...
export default withTranslation()(SocialMediaAccountLoginScreen);
