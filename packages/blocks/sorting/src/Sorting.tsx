        ...
        <View style={styles.topContainer}>
          ...
          >
            <Icon
              ...
              color="#808080"
            />
            <Text style={styles.topText}>{t("Sort")}</Text>
          </TouchableOpacity>
        </View>
          ...
          <View style={styles.modalContainer}>
            ...
            >
              <Icon
                ...
                color="#808080"
              />
              <Text style={styles.sortText}>{t("PriceLowToHigh")}</Text>
            ...
            >
              <Icon
                ...
                color="#808080"
              />
              <Text style={styles.sortText}>{t("PriceHighToLow")}</Text>
            ...
            >
              <Icon
                ...
                color="#808080"
              />
              <Text style={styles.sortText}>{t("NewestProducts")}</Text>
            ...
            >
              <Icon
                ...
                color="#808080"
              />
              <Text style={styles.sortText}>{t("Popularity")}</Text>
              {this.state.popular && (
                <Icon
                  name="check-circle"
                  size={16}
