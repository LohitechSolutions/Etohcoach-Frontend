...
class AdminConsole3 extends AdminConsole3Controller {
          ...
          <View>
            ...
            <View style={styles.bgPasswordContainer}>
              <TextInput
                ...
                placeholder={t("EnterText")} //UI Engine::From Sketch
            ...
            <Button
              ...
              title={t("CLICKME")} //UI Engine::From Sketch
...
export default withTranslation()(AdminConsole3); 