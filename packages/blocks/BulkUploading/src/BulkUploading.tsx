      ...
      <ScrollView keyboardShouldPersistTaps="always" style={styles.container}>
        ...
        >
          ...
          <View>
            ...
            {langaugeDatafromapi ? langaugeDatafromapi.ThisRevicedValue : i18n.t("ThisRevicedValue")}
            ...
            <View style={styles.bgPasswordContainer}>
              <TextInput
                ...
                placeholder={langaugeDatafromapi ? langaugeDatafromapi.EnterText : i18n.t("EnterText")} //UI Engine::From Sketch
            ...
            <Button
              ...
              title={langaugeDatafromapi ? langaugeDatafromapi.CLICKME : i18n.t("CLICKME")} //UI Engine::From Sketch
