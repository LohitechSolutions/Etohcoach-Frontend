    ...
    return (
      ...
      <SafeAreaView style={styles.safeAreaContainer}>
        ...
        <View style={styles.mainContainer}>
          ...
          >
            {t("ValuePropositionWhyUsersShouldSignUp")}
          ...
          >
            ...
            >
              {t("SignUpWithFacebook")} {/*UI Engine::From Sketch*/}
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
          ...
          >
            ...
            >
              {t("SignUpWithGoogle")} {/*UI Engine::From Sketch*/}
            </Text>
          </TouchableOpacity>
          <Text
          ...
          >
            ...
            >
              {t("SignUpWithEmailAndPassword")} {/*UI Engine::From Sketch*/}
            </Text>
          </TouchableOpacity>
...
export default withTranslation()(SocialMediaAccountRegistrationScreen);
