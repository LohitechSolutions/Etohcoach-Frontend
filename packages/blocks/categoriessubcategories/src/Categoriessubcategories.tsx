    ...
    return (
      <ScrollView style={styles.container}>
          ...
          >
            <View style={styles.modal}>
              {this.state.activeModalType === "SubCategory" ? (
                <View>
                  <Text style={styles.addCategoryTitle}>{t("AddASubcategory")}</Text>
                  <TextInput
                ...
                <View>
                  <Text style={styles.addCategoryTitle}>{t("AddACategory")}</Text>
                  <TextInput
                    testID="txtInputCategory"
                    style={styles.bgMobileInput}
              ...
              <View style={styles.buttonBox}>
                ...
                >
                  <Text style={styles.viewBtnText}>{ t("Add")}</Text>
                </TouchableOpacity>
                <TouchableOpacity
        ...
        <View style={styles.btnContainer}>
          ...
          >
          <Text style={styles.addtext}>{t("AddSubCategory")}</Text>
          </TouchableOpacity>
        </View>
